        ...
        <div className="bg-gray-100 p-2 rounded-md shadow-md w-full max-w-5xl border-4 border-indigo-600 pl-9 pr-9 ">
          ...
          <div className="mb-2">
              ...
              <div className="flex items-center">
                ...
                <div>
                  <p className="font-bold text-lg">
                    Explain what promote discount in?
                  </p>
            ...
            <div className="bg-white rounded-md p-5 mb-3 ">
              ...
              Increase Sales: Discounts are often used to encourage customers to make a purchase by providing a financial incentive.
              Clear Inventory: Merchants may offer discounts to clear out old or excess inventory.
              Attract New Customers: Special promotions can attract new customers and encourage them to try a product or service
              <br />
            <div className='pl-4'>
...
// "use client"
// import React from 'react';
// import Sidebar from '../screen2/sidebartwo'; // Assuming the correct path to Sidebar component
// import { Button, TextField, InputAdornment, IconButton, Avatar, Paper, Typography } from '@mui/material';
...
//   },
//   button: {
//     marginRight: useTheme().spacing(8),
...
//   },
//   paper: {
//     background: 'linear-gradient(to right, #7F9CF5, #76B8F4)',
//     padding: useTheme().spacing(2),
//     borderRadius: '12px',
...
//     },
//     '& .avatar': {
//       marginRight: useTheme().spacing(4),
//       width: useTheme().spacing(9),
//       height: useTheme().spacing(9),
//     },
//     '& .edit-button': {
//       background: 'white',
//       borderRadius: 'full',
...
//       justifyContent: 'center',
//       background: '#68D391',
//       marginBottom: useTheme().spacing(9),
//       '& .search-input': {
//         // background: '#CBD5E0',
//         padding: useTheme().spacing(2),
//         paddingTop: useTheme().spacing(1.5),
...
//             <Avatar src="https://randomuser.me/api/portraits/men/1.jpg" className="avatar" />
//           </div>
//           <div>
...
//           <div className="mb-2 profile-container">
//             <div className="flex items-center">
//               <Avatar src="https://randomuser.me/api/portraits/men/1.jpg" className="avatar" />
//               <div>
//                 <Typography variant="h5" className="mb-2">
...
//               Increase Sales: Discounts are often used to encourage customers to make a purchase by providing a financial
//               incentive. Clear Inventory: Merchants may offer discounts to clear out old or excess inventory. Attract New
//               Customers: Special promotions can attract new customers and encourage them to try a product or service
//             </Typography>
//           </div>
...
//      <div className="pl-9 alighn-items center width:100%">
//       <div className={classes.flexCenter}>
//         <Paper className={classes.paper}>
//           <div className="mb-2 pl-9 profile-container">
//             <div className="flex items-center">
//               <Avatar src="https://randomuser.me/api/portraits/men/1.jpg" className="avatar" />
//               <div>
//                 <Typography variant="h5" className="mb-2">
